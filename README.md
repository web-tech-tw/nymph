...
### 2. 在 LINE 中使用
* 加入 Nymph 官方帳號或在已加入 Nymph 的社群中直接發送訊息，寧芙將自動辨識語境並回覆。
...
1. 開啟瀏覽器前往 Nymph 服務網站的權杖管理頁面（`/mcp/tokens`）。
...
* 統一認證平台：[web-tech.tw/sara](https://web-tech.tw/sara)
* 參與交流：歡迎加入 Discord 或 LINE 社群與我們互動！
